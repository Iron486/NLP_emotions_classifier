...
Unfortunately, I could not put GloVe wembeddings in the data folder since they occupy more than 100 MB of memory, but it's possible to download them from the website.
